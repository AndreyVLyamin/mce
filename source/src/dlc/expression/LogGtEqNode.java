 ...
 */
public class LogGtEqNode extends OpNode{

	/** INode.PRIOR_EQ */
    public int priority = INode.PRIOR_EQ;

    public LogGtEqNode( CodeToken source ){
        super( source );
    }
    ...
    public Object proceed( VariableContainer vars ) throws Exception{
        ...
        if( left == null || right == null ){
            System.out.println("ERROR: LogGtEqNode.proceed() - left or right is null!");
        ...
        try{
            ...
            System.out.println("ERROR: LogGtEqNode.proceed() - unknown type of nodes: " + v[0].getClass().getName() );
