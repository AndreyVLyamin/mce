 ...
 */
public class LogLtEqNode extends OpNode {
    ...
    public LogLtEqNode(CodeToken source) {
        super( source );
    }
    ...
    public Object proceed(VariableContainer vars) throws Exception {
        ...
        if (left == null || right == null) {
            System.out.println( "ERROR: LogLtEqNode.proceed() - left or right is null!" );
        ...
        try {
            ...
            System.out.println( "ERROR: LogLtEqNode.proceed() - unknown type of nodes: " + v[0].getClass().getName() );
