 ...
 * Оператор Меньше
 */
public class LogLtNode extends OpNode{

	/** INode.PRIOR_EQ */
    public int priority = INode.PRIOR_EQ;

    public LogLtNode( CodeToken source ){
        super( source );
    }
    ...
    public Object proceed( VariableContainer vars ) throws Exception{
        ...
        if( left == null || right == null ){
            System.out.println("ERROR: LogLtNode.proceed() - left or right is null!");
        ...
        try{
            ...
            System.out.println("ERROR: LogLtNode.proceed() - unknown type of nodes: " + v[0].getClass().getName() );
